...
public class UpdateTask extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener  {
    ...
    /*Radio boxes that checks whether a task is marked completed/uncompleted*/
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.menu_item_1:
                Intent intent1 = new Intent(UpdateTask.this, CompletedTasks.class);
                Toast.makeText(this, "Completed tasks clicked", Toast.LENGTH_SHORT).show();
                startActivity(intent1);
                return true;
            case R.id.menu_item_2:
                Intent intent2 = new Intent(UpdateTask.this, Settings.class);
                Toast.makeText(this, "Settings clicked", Toast.LENGTH_SHORT).show();
                startActivity(intent2);
                return true;
            case R.id.menu_item_3:
                Intent intent3 = new Intent(UpdateTask.this, About.class);
